...
public class HttpRequestTest extends HttpServlet {
	...
	private void testNaver() {
		...
		headers.put("X-Naver-Client-Id", "NHTKvhOMQjXBN4alJcej");
		headers.put("X-Naver-Client-Secret", "wSd1tpdN7i");
		headers.put("Content-Type", "application/json");
		
		
		List<String> javaKeywords = new ArrayList<String>();
		javaKeywords.add("스프랑");
	...
	private void testKakao() {
		...
		Map<String, String> headers = new HashMap<String, String>();
		headers.put("Authorization", "KakaoAK 63d2b5c6db87832d9ff2994c0db9cfc4");
