...
public class MailSender {
	...
	public void sendEmail(String to, String subject, String body) {
	    ...
	    try {
	    	...
	    	throw new HandlableException(ErrorCode.MAIL_SEND_FAIL, mex);
	    }
	}
	...
	private void sendMessage(Session session, MimeMessage msg) throws MessagingException {
        ...
        tr.connect("smtp.gmail.com", Config.SMTP_AUTHENTICATION_ID.DESC, Config.SMTP_AUTHENTICATION_PASSWORD.DESC); //보내는사람
        msg.saveChanges();
